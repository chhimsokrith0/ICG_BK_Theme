                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <div className="flex items-center border border-gray-300 p-2 rounded-md">
                                <p className="text-gray-700 flex-1">vodydkkr</p>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse border-spacing-0">
                            <thead className="bg-gray-100 border-b">
                                <tr>
                                    <th className="px-4 py-3 text-gray-700 font-medium">Member Login</th>
                                    <th className="px-4 py-3 text-gray-700 font-medium">Register Time</th>
                                    <th className="px-4 py-3 text-gray-700 font-medium">Currency</th>
                                    <th className="px-4 py-3 text-gray-700 font-medium">Total Deposit</th>
                                    <th className="px-4 py-3 text-gray-700 font-medium">Bonus Amount</th>
