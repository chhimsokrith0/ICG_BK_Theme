    ...
    return (
        <div className="space-y-4 mt-8">
            {promotions.map((promo, index) => (
                <div
                    key={index}
                    className="bg-white rounded-lg flex flex-col md:flex-row items-center overflow-hidden"
                >
                    ...
                    <div className="md:w-2/3 flex justify-between items-center px-6 py-4">
                        <div className="flex-1">
                            ...
                            <div className="mt-4 flex space-x-2">
                                <button onClick={() => setIsModalOpen(true)} className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-400 transition">
                                    More Info
                                </button>
                                <Link href="/register" className="bg-orange-500 text-white py-2 px-4 rounded hover:bg-orange-400 transition">
                                    Join now
                                </Link>
                            </div>
                        </div>
                        <div className="text-center bg-gray-100 p-4 rounded-lg ml-4">
