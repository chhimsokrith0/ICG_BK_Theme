...
const VIPSection = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth <= 768) {
        // Mobile
        setBgImage("https://res.cloudinary.com/dfxqagrkk/image/upload/v1737287622/m-about-background_fpklmz.jpg")
      } else {
        // Desktop
        setBgImage("https://res.cloudinary.com/dfxqagrkk/image/upload/v1737193449/about-background_wl7rdv.jpg")
      }
    }
  ...
  return (
    <div id="upgrade" className="bg-[#0b2134] p-4 md:p-10">
      ...
      >
        {/* Content */}
        <div className="relative z-10 w-full flex flex-col items-start text-center lg:text-left lg:flex-row">
